...
const About = () => {
    ...
    return(
        <>
            <div className="mt-[60px] px-[128px] ">
                ...
                <div className=' flex gap-[5%] w-full'>
                    <div className='w-[25%] font-[Geist] text-[#FFFFFF] font-bold text-[20px]  flex flex-col justify-center items-center'>                     
                    ...
                    <div className=' w-[75%] font-[Inter] italic text-[16px] text-[#FFFFFF]' >
