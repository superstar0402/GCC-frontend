        ...
        <>
            <div className="mt-[60px] px-[128px] pb-[80px] ">
                ...
                <div className=' flex gap-[5%] w-full'>
                    <div className='w-[25%] font-[Geist] text-[#FFFFFF] font-bold text-[20px]  flex flex-col justify-center items-center bg-[pink]'>                     
                    ...
                    <div className=' w-[75%] font-[Inter] italic text-[16px] text-[#FFFFFF] bg-[green]'>
